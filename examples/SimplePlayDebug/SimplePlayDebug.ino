...
void setup()
{
  ...
  pdexed = new AudioSynthDexed(4,DEXED_SAMPLE_RATE);
  patchCord1.connect(*pdexed, 0, i2s1, 0);
  patchCord2.connect(*pdexed, 1, i2s1, 1);
